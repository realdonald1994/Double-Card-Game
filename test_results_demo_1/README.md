...
| #11| ... <br> (recycle前输入与#8相同) <br> (recycle moves start) <br> A 9 B 9 3 F 8 <br> F 8 G 8 4 E 4 | <img src="test_case_11_result.png" width="380"> | **Failed** | 测试recycle环节 <br> player2拿起player1刚刚移动过的卡片 <br> 应提示player2重新选择要拿起的卡片 |
