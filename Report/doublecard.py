...
def evaluation_2(board, player):
    ...
    if player == 'color':   # AI plays color
    ...
    return SCOREAI - SCOREHUMAN
    # # the larger value of the overall goodness vs. danger is used to determine whether or not the board is good or dangerous
    # if danger > good:
    #     # for dangerous values, the whole number is multiplied by -1
    #     return danger * (-1)
    # else:
    #     return good
