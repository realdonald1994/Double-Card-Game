...
| #11| ...(recycle前输入与#8相同) <br> (recycle moves start)  | ...  | ...  | 测试recycle环节 <br> player2拿起player1刚刚移动过的卡片 <br> 应提示player2重新选择落字的位置 |
| #12| ...(recycle前输入与#8相同) <br> (recycle moves start)  | ...  | ...  | 测试recycle环节 <br> player1拿起一张卡片不做任何操作，放回原先位置情况  |
| #13| ...  | ...  | ...  | 测试player1选择颜色，player1赢的情况  |
| #14| ...  | ...  | ...  | 测试player1选择颜色，player1输得情况 |
| #15|   |   |   |   |
