...
| #12| ... <br> (recycle前输入与#8相同) <br> (recycle moves start)  | ...  | ...  | 测试recycle环节 <br> player1拿起一张卡片不做任何操作，放回原先位置情况，应提示player1重新选择落字的位置  |
| #13| ... <br> (recycle前输入与#8相同) <br> (recycle moves start)  | ...  | ...  | 测试recycle环节 <br> 由于player1拿起的一张卡片而导致board出现invalid configuration的情况，应当提示player1重新选择要拿起的卡片  |
